	...
	<head>
		...
		<script>
			...
			$("button").click(function(){
				$(".nav-list-small").toggleClass("block");
			}); 
				...
				<!-- Contact Us section starts here -->
					...
					<div id="contact" class="row contact-1" style="position:fixed;width:100%;gray:#949596;">
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<h2 style="color:#34d6c1">Feedback Form-</h2>
									  <form style="text-align:left">
										<div class="form-group">
										  <label for="name" style="color:#ccdde0;">Name:</label>
										  <input type="text" class="form-control" id="name" placeholder="Enter your name">
										</div>
										<div class="form-group">
										  <label for="email" style="color:#ccdde0;">Email:</label>
										  <input type="email" class="form-control" id="email" placeholder="Enter email">
										</div>
										<div class="form-group">
										<label style="color:#ccdde0;">Enter your message here:</label>
							...
							<div class="col-md-6 contact">
								<div class="col-md-10 col-md-offset-2" style="text-align:left">
									<h3 style="color:#34d6c1">ADDRESS:</h3>
									<p style="color:#ccdde0;">
										<i class="fa fa-map-marker"></i> ABC WING,<BR/>
								...
								<div class="col-md-10 col-md-offset-2" style="text-align:left">
									<h3 style="color:#34d6c1">CALL US:</h3>
									<p style="color:#ccdde0;">
								...
								<div class="col-md-10 col-md-offset-2" style="text-align:left">
									<h3 style="color:#34d6c1">E-MAIL:</h3>
									<p style="color:#ccdde0;">
