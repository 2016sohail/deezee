...
<html>
	...
	<body style="background-color:#000;">
			...
			<!-- Home section starts here  -->
					...
					<div class="row" style="background-color:#fff;opacity:0.99;padding:10px 80px;padding-bottom:20px">
						<h3 style="text-align:center;color:#2d6392;margin-bottom:15px;font-size:40px"><span style="color:#2d6392;font-size:10px">:::::::::::::::::::::::</span> <strong>WHO WE ARE</strong> <span style="color:#2d6392;font-size:10px">:::::::::::::::::::::::</span></h3>
						<div class="col-md-4 who">
							...
							<div style="text-align:center;padding:0px 36px">
								<p style="text-align:center;font-size:18px;color:#2d6392">CREATIVE</p>
						...
						<div class="col-md-4 who">
							...
							<div style="text-align:center;padding:0px 36px">
								<p style="text-align:center;font-size:18px;color:#2d6392">PASSIONATE</p>
						...
						<div class="col-md-4 who">
							...
							<div style="text-align:center;padding:0px 36px">
								<p style="text-align:center;font-size:18px;color:#2d6392">PROFESSIONALS</p>
